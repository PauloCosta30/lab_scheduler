...
# --- INÍCIO DA CORREÇÃO ---
# A linha que adiciona o caminho correto DEVE VIR PRIMEIRO, antes de qualquer 'from src...'
# Isso ensina ao Python onde encontrar a pasta 'src'.
...
# Carregar as variáveis de ambiente (essencial para o Render)
load_dotenv()
...
# Configuração das chaves e do banco de dados
